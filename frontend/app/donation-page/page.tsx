          ...
          <form className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="item">Qual item quer doar?</Label>
                <Input
                  id="item"
              ...
              <div className="space-y-2">
                <Label htmlFor="email">Indique seu melhor e-mail</Label>
                <Input
                  id="email"
                  type="email"
            ...
            <div className="space-y-2">
              <Label htmlFor="description">Escreva detalhadamente o estado do item</Label>
              <Textarea
                id="description"
            ...
            <div className="space-y-2">
              <Label>Você pode entregar o seu item em Rua MMDC, São Paulo, Butantã?</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="address">Qual o seu endereço?</Label>
              <Input
                id="address"
